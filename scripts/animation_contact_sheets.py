...
def write_index(md_path, title, intro, entries):
    ...
    md = [f"# {title}", "",
          "_Auto-generated by `scripts/animation_contact_sheets.py`._", "",
          intro, "",
...
def cmd_character(name, out_dir, md_path):
    ...
    md.append("")
    md.append("_Auto-generated by `scripts/animation_contact_sheets.py`. "
              "Regenerate after re-extracting sprites:_")
    md.append("")
    md.append("```")
    md.append("SDL_VIDEODRIVER=dummy uv run python scripts/animation_contact_sheets.py")
    md.append("```")
    md.append("")
